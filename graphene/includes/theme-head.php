...
$style = '';
	...
	// Link style
	if ( $graphene_settings['link_colour_normal'] != $graphene_defaults['link_colour_normal']) { $style.='a,.post-title,.post-title a{color:'.$graphene_settings['link_colour_normal'].';}';}
