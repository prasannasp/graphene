...
function graphene_options_general() { 
    ...
    ?>
        ...
        <div class="postbox non-essential-option">
         ...
         <?php /* RSS Feed Options */ ?>
        <div class="postbox">
            <div class="head-wrap">
                <div title="Click to toggle" class="handlediv"><br /></div>
        		<h3 class="hndle"><?php _e( 'RSS Feed Options', 'graphene' ); ?></h3>
            </div>
            <div class="panel-wrap inside">
                <table class="form-table">
                    <tr class="non-essential-option">
                        <th scope="row">
                            <label for="use_custom_rss_feed"><?php _e( 'Use a custom RSS Feed', 'graphene' ); ?></label>
                        </th>
                        <td><input type="checkbox" name="graphene_settings[use_custom_rss_feed]" id="use_custom_rss_feed" <?php checked( $graphene_settings['use_custom_rss_feed'] ); ?> value="true" data-toggleOptions="true" /></td>
                    </tr>
                </table>
                 <table class="form-table site-summary<?php if ( $graphene_settings['use_custom_rss_feed'] == false ) echo ' hide'; ?>">
                    <tr>
                    	<th scope="row">
                            <label for="custom_rss_feed_url"><?php _e( 'Custom RSS Feed url', 'graphene' ); ?></label>
                        </th>
                        <td>
                            <input type="text" name="graphene_settings[custom_rss_feed_url]" value="<?php echo $graphene_settings[custom_rss_feed_url] ?>" class="widefat code" />
                        </td>
                    </tr>
                 </table>
            </div>
                ...
                <table class="form-table social-media-table<?php if ( $graphene_settings['hide_top_bar'] == true ) echo ' hide'; ?>">
                    ...
                    <tr class="non-essential-option">
                        <td colspan="2" id="socialprofile-sortable">                            
                            <?php        
                                // Credits go to Nouveller for the icons - Social Media Bookmark-Iconscollection
                                // http://www.nouveller.com/general/free-social-media-bookmark-icon-pack-the-ever-growing-icon-set/
                                $available_profiles = array (   'Twitter', 'Facebook', 'LinkedIn', 'RSS', '-', 'Custom', '-',
                                ...
                                <table class="form-table socialprofile-table">
                                    <tr>
                                        <th scope="row" rowspan="<?php echo $profile_data['type'] == 'custom' ? '3' : '2'; ?>" class="small-row">                            
                                            ...
                                            <img class="mysocial-icon" src="<?php echo $profile_data['icon_url']; ?>" />
                                            <?php else : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ( $profile_data['type'] == 'rss' ) : ?>
                                                <br /><span class="description"><?php _e('Leave the url empty to use the default RSS url (or the custom RSS url if set in the RSS Feed option).', 'graphene'); ?></span>
                                            <?php endif; ?>
                                    <?php if ( $profile_data['type'] == 'custom' ) : ?>
                                        </td>
                                    </tr>
                            ...
                            <table class="socialprofile-dragging">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="new-socialprofile-type">
                                            <option disabled="disabled" value="-">- Choose type -</option>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="new-socialprofile-url" class="widefat code" />
                                        <span id="new-socialprofile-url-description" class="hide"><?php _e('Leave the url empty to use the default RSS url (or the custom RSS url if set in the RSS Feed option).', 'graphene'); ?></span>
                                    </td>
                                </tr>
                                <tr class="hide">
