        ...
        <div class="postbox non-essential-option">
            ...
            <div class="panel-wrap inside">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <label for="content_font_colour"><?php _e( 'Title text colour', 'graphene' ); ?></label>
                        </th>
                        <td>
                            <input type="text" class="code color-<?php echo $counter; ?>" name="graphene_settings[title_font_colour]" id="title_font_colour" value="<?php echo $graphene_settings['title_font_colour']; ?>" />
                            <a href="#" class="clear-color"><?php _e( 'Clear', 'graphene' ); ?></a>
                            <div class="colorpicker" id="colorpicker-<?php echo $counter; $counter++; ?>"></div>
                        </td>
                    </tr>
